...
**Organized path**:
The on-disk location of a completed upload, under `organized/YYYY/MM/DD/<filename>`. Stored on the upload record as `OrganizedPath`, set only when a record reaches `complete` status.
